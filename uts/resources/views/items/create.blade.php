...
<div class="mb-10">
    ...
    <h1 class="font-heading text-5xl md:text-6xl italic tracking-wide text-gray-900">Tambah Produk</h1>
    <p class="text-gray-600 mt-2 text-lg">Silakan isi formulir di bawah ini untuk menambahkan produk skincare baru.</p>
</div>
    ...
    <form action="{{ route('items.store') }}" method="POST">
        ...
        <div class="mb-8">
            ...
            <textarea name="description" id="description" rows="5" 
                ...
                placeholder="Jelaskan manfaat dan kandungan utama produk...">{{ old('description') }}</textarea>
            @error('description')
                <p class="text-red-500 text-sm mt-2 font-medium">{{ $message }}</p>
            @enderror
        </div>
