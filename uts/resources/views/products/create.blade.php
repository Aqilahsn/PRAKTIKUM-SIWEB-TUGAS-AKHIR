...
<div class="max-w-2xl mx-auto">
    <div class="mb-8">
        ...
        <h1 class="font-heading text-3xl font-bold text-gray-900">Tambah Produk Baru</h1>
    </div>
    ...
    <div class="bg-white rounded-lg shadow-lg p-8">
        <form action="{{ route('products.store') }}" method="POST" class="space-y-6">
            ...
            <!-- Kode Produk -->
            <div>
                <label for="kode_produk" class="block text-gray-700 font-semibold mb-2">Kode Produk (Unique)</label>
            ...
            <div class="grid grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="number" name="harga" id="harga" value="{{ old('harga', 0) }}"
            ...
            <div class="flex gap-4 pt-4">
                <button type="submit" class="btn-success flex-1 py-3 rounded-lg font-semibold">
                    Simpan Produk
                </button>
